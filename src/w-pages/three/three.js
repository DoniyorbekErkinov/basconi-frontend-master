...
THREE.Matrix4.prototype = {
    ...
    multiplySelf: function (c) {
        var o = this.n11, n = this.n12, k = this.n13, i = this.n14, f = this.n21, e = this.n22, d = this.n23,
            b = this.n24, a = this.n31, r = this.n32, q = this.n33, p = this.n34, l = this.n41, j = this.n42,
            h = this.n43, g = this.n44;
...
THREE.CanvasRenderer = function () {
    var A = null, v = new THREE.Projector(), s = document.createElement("canvas"), n, r, k, p, t = s.getContext("2d"),
        ...
        o = new THREE.Color(4294967295), x = new THREE.Color(4294967295), f = new THREE.Color(4294967295),
        y = Math.PI * 2, j = new THREE.Vector2(), h = new THREE.Vector3(), G = new THREE.UV(), F = new THREE.UV(),
        E = new THREE.UV(), C = new THREE.UV(), d = new THREE.Vector2(), b = new THREE.Vector2();
    this.domElement = s;
    this.autoClear = true;
    this.setSize = function (I, H) {
        n = I;
...
THREE.SVGRenderer = function () {
    var w = null, r = new THREE.Projector(), s = document.createElementNS("http://www.w3.org/2000/svg", "svg"), k, A, p,
        ...
        u = new THREE.Color(4294967295), c = new THREE.Color(4294967295), g = new THREE.Vector3(), d = [], m = [], B, o,
        f, z = 1;
    this.domElement = s;
    this.autoClear = true;
