...
<!--      <vs-button @click="print" icon flat dark><q-icon name="print"/></vs-button>-->
    ...
    <q-table :data="income.whDocItems" :columns="columns" row-key="id" row="row" hide-pagination :rows-per-page-options="[0]" class="mt-2">
              ...
              <vs-row align="flex-end">
                <vs-col>
                  <vs-input
                    ...
                    v-model="dynamic.count[props.rowIndex]"
                  />
                </vs-col>
              </vs-row>
            </validation-provider>
